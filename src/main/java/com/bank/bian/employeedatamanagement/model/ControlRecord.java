package com.bank.bian.employeedatamanagement.model;
...
/**
 * The BIAN control record for this service domain: "Employee Record Maintenance Agreement".
 *
 ...
 * to its asset type (Employee Record). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Employee Record Maintenance Agreement";
